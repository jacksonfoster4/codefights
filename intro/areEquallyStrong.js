...
function areEquallyStrong(yourLeft, yourRight, friendsLeft, friendsRight) {
    ...
    let friendStrongest = Math.max(friendsLeft, friendsRight)
    let yourLift = yourLeft + yourRight
    let friendsLift = friendsLeft + friendsRight
    return yourStrongest == friendStrongest && yourLift == friendsLift
}
